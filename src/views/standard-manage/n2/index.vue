<template>
  <div class="container page-margin">
    <a-card class="list-container" title="N2户型" :bordered="false">
      ...
      <TableBase :loading="loading" :list-data="listData" @refresh="getList" />
    </a-card>
    <modal
...
<script lang="ts" setup>
  ...
  const { listData, getListData } = useGetList(getBusinessParamListApi, { module: 2 })
